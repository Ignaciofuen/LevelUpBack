    ...
    CommandLineRunner initDatabase(ProductoRepository repository) {
        return args -> {
            ...
            if (repository.count() == 0) {
                System.out.println("Poblando la base de datos con los 10 productos iniciales...");
                ...
                // 3. PC GAMER RDY Y70 Liquid Hybrid Max
                ...
                // 4. TECLADO GAMER REDRAGON UCAL K673
                ...
                // 5. TECLADO REDRAGON K530W DRACONIC BLC
                ...
                // 7. SILLA GAMER COUGAR TERMINATOR
                ...
                // 10. POLERA LEVEL-UP-GAMER (NUEVO)
                ...
                System.out.println("¡10 productos iniciales cargados correctamente en MySQL!");
            } else {
